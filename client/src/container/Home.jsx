...
<<<<<<< HEAD
      <div className="flex justify-between items-center mt-12 mx-16">
        <div>
          <p className="text-3xl font-semibold">India's First</p>
          <p className="text-6xl font-bold mb-2">EARNING</p>
          <p className="text-6xl font-bold mb-2">REWARD</p>
          <p className="text-6xl font-bold mb-6">APPLICATION</p>
          <Link to="/register">
            <button className="rounded-full bg-[#4478E4] text-white text-3xl px-7 py-2">
              Join Now
            </button>
          </Link>
          <div className="mt-4 flex space-x-2">
            <a href={() => false}>
              <svg viewBox="0 0 512 512" className="w-10">
            ...
            <a href="https://github.com/ZiaCodes/claim-prize">
              <svg viewBox="0 0 512 512" className="w-10">
      ...
      <div className="home-box mt-12 mx-16">
        ...
        <div className="flex justify-between items-center mt-12 mx-16">
          ...
          <div className="hide-on-mobile flex landing-div">            
            ...
            />
>>>>>>> bfd65bfccd82fc78ff72cea57555db36cf350483
          </div>
